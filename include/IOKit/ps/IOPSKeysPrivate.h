...
/*
 * apple-core addition, for PowerManagement's ioupsd.  IOKitUser-100231.120.3
 * does not define this key; stock /usr/libexec/ioupsd (macOS 26.5.2, 25F84)
 * carries "Model Number" beside "Vendor ID" and "Product ID", the values of
 * the public kIOPSVendorIDKey and kIOPSProductIDKey it stores next to it.
 */
#define kIOPSModelNumber      "Model Number"
